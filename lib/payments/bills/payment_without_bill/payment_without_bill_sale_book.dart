...
class PaymentWithoutBillSaleBookScreen extends StatefulWidget {
  ...
  @override
  State<PaymentWithoutBillSaleBookScreen> createState() =>
      _PaymentWithoutBillSaleBookScreenState();
}
...
class _PaymentWithoutBillSaleBookScreenState
    extends State<PaymentWithoutBillSaleBookScreen> {
  @override
                                            ...
                                            Row(
                                                ...
                                                children: [
                                                  Flexible(
                                                      flex: 2,
                                                      child: Text(
                                                          'Malayan Parasite, 1954. Study no.26')),
                                                  Flexible(
                                                      flex: 1,
                                                      child: Text('RM ' +
                                                          60.toString())),
                                            ...
                                            Row(
                                                ...
                                                children: [
                                                  Flexible(
                                                      flex: 2,
                                                      child: Text(
                                                          'Rabies in Malaya, 1956. Bulletin no. 8')),
                                                  Flexible(
                                                      flex: 1,
                                                      child: Text('RM ' +
                                                          30.toString())),
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 10),
                                      Text(
                                          '1 X Malayan Parasites XVI - XXXIV, 1956.'),
                                      SizedBox(height: 10),
                                      Text(
                                        'Bulletin of the Institute of Medical Research',
                                        style: styles.heading10bold,
                                      ...
                                      SizedBox(height: 10),
                                      Text(
                                          '1 X Rabies in Malaya, 1956. Bulletin no. 8'),
                                    ],
                                  ),
                                ],
                              ),
